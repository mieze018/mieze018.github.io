          ...
          <ul>
            ...
            <li>
              ...
              <ul>
                <li>
                  <i>CDアートワーク：</i>
                  Laxenanchaos『Transform Ordinary Events Into Miracles』Virgin
                  Babylon Records
                </li>
                <li>
                  <i>文庫本装画：</i>
            ...
            <li>
              ...
              <ul>
                ...
                <li>
                  <i>文芸誌扉絵：</i>
                  早川書房 S-Fマガジン 『コンピューターお義母さん』澤村伊智 著
                </li>
                <li>
                  <i>単行本装画：</i>
            ...
            <li>
              ...
              <ul>
                ...
                <li>
                  <i>文芸誌扉絵：</i>
                  角川書店 文芸カドカワ 『あとは野となれ大和撫子』宮内悠介 著
                </li>
                <li>
                  <i>メイキング：</i>
                ...
                <li>
                  <i>単行本装画：</i>
                  中央公論新社『マレ・サカチのたったひとつの贈物』王城夕紀 著
                  /装幀・鈴木成一デザイン室
                </li>
                <li>
                  <i>文芸誌扉絵：</i>
